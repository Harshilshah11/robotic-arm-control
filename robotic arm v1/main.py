...
# default_p1  = [-50.0, 35.0, -30.0]
# default_p2 = [45.0, 35.0, -30.0]
...
def pick_place():
    ...
    # if saved_movement_1 is None or saved_movement_2 is None:
...
def pick_place_default():
    ...
    # ---- HALF MOVE (safe) ----
    move_stepper(default_p1[0] * 0.5, joint1)

    solve_d3(default_p1[1] * 0.5)
    move_stepper(default_p1[1] * 0.5, joint2)

    solve_d2(default_p1[2] * 0.5)
    move_stepper(default_p1[2] * 0.5, joint3)
    ...
    # ---- GO ABOVE (safe height) ----
    move_stepper(default_p2[0] - 5, joint1)

    solve_d3(default_p2[1] - 5)
    move_stepper(default_p2[1] - 5, joint2)

    solve_d2(default_p2[2] + 10)
    move_stepper(default_p2[2] + 10, joint3)
...
<button class="btn-warn" onclick="fetch('/start_continuous')">
      ▶️ Start Continuous Run
    </button>

    <button class="btn-dng" onclick="fetch('/stop_continuous')">
      ⏹️ Stop Continuous Run
    </button></div>
</div>
</div>
<script>
    ...
    while True:
        try:
            ...
            if path.startswith('/arnobot.jpeg'):
                ...
                print("Saving Position 1...")

                saved_movement_1.clear()

                saved_movement_1.extend([

                    joint1.currentDegree,

                    joint2.currentDegree,

                    joint3.currentDegree
                ...
                print("Saving Position 2...")

                saved_movement_2.clear()

                saved_movement_2.extend([
